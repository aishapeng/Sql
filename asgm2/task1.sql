...
(p_name VARCHAR2) AS
    ...
    CURSOR cur_publicationList(p_aid VARCHAR2) IS
        SELECT DISTINCT w.pubid AS pubid, 
        CASE 
...
BEGIN
                ...
                LOOP
                    ...
                    IF v_found = 0 THEN
                        ...
                        LOOP
                            ...
                            rec_pubid1.pubid := v_journal.pubid;
                    ...
                    IF v_found = 0 THEN
                        ...
                        LOOP
                            ...
                            rec_pubid1.pubid := v_proceedings.pubid;
    ...
    ELSE 
        v_total_count := cur_publicationList%ROWCOUNT;
    END IF;
    ...
    FOR i IN pubid_table1.FIRST..pubid_table1.LAST LOOP
        ...
        DBMS_OUTPUT.PUT_LINE('Type: '|| pubid_table1(i).pubid);
        --Print authors name
        DBMS_OUTPUT.PUT('Authors: ');
        IF NOT cur_author_name%ISOPEN THEN
            OPEN cur_author_name(pubid_table1(i).pubid);
        END IF;
        LOOP
